                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Date</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">HS Code</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Product Description</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Origin Country</h4>
                                </th>
                                <th class="table-primary p-3">
                                   <h4 class="fw-semibold text-star">Unloading Port</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">QTY.</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Unit</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Weight</h4>
                                </th>
                                <th class="table-primary p-3">
                                    <h4 class="fw-semibold text-star">Exporter Name</h4>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @if(isset($Dresult) && $Dresult->count() > 0)
                                @foreach ($Dresult as $Dresult)
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-normal text-gray p-3" style="word-break: break-all;">
