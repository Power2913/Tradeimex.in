                                ...
                                if ($all_numeric) {                              
                                    ...
                                    if(count($args)== 5){
                                        ...
                                        if($filterby=='hs_code'){
                                            ...
                                            $port_url = route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$searfilterdata,'filterdata1' => $unloading_port ?? 'null']);
                                            ...
                                            if($filterby1=='hs_code'){
                                                $hs_code_url =  route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$res_hs_code,'filterdata1' => $unloading_port]);
                                                ...
                                                $port_url = route('searchfilterone', ['type' => $type, 'role' => $role,'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$searfilterdata,'filterdata1' => $unloading_port]);
                                            }else if($filterby1=='port'){
                                                //dd('In this Group');
                                                $hs_code_url =  route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$res_hs_code,'filterdata1' => $unloading_port]);
                                                $country_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role, 'filterby2' => 'country','filterby'=>$filterby,'filter'=>$filterdata,'filterby1'=>$filterby1,'filterdata' => $filterdata1, 'filterdata1' => $Dresult->ORIGIN_COUNTRY]);
                                                $port_url = route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$searfilterdata,'filterdata1' => $unloading_port]);
                                            ...
                                            $country_url = route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'country','filterby'=>$filterby,'filterdata'=>$searfilterdata,'filterdata1' => $country]);
                                            $port_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $country, 'filterdata1' => $unloading_port]);
                                            }
                                    }
                                            ...
                                            if($filterby1 == 'country'){
                                                ...
                                                $base_search = $search;
                                                    ...
                                                    $unloading_port = str_ireplace(" ", "-", $unloading_port);
                                                    //Hs code Url
                                                    $hs_code_url =  route('search-filter-one', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'base_search'=>$res_hs_code??'null', 'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$filterdata,'filterdata1' => $unloading_port??'null']);
                                                
                                                    //Country Url
                                                    $country_url =  route('search-filter-one', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'base_search'=>$searchDetails1, 'filterby1' => 'port','filterby'=>$filterby,'filterdata'=>$filterdata,'filterdata1' => $unloading_port??'null']);
                                                
                                                //Port Url 
                                                    $port_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$search,'filter'=>$searchDetails1,'filterby1'=>$filterby,'filterdata' => $filterdata ,'filterdata1' => $unloading_port??'default']);
                                            }
                                        }
                                        else if(count($arg)==9){
                                            $unloading_port = str_ireplace(" ", "-", $unloading_port);
                                        ...
                                        if($filterby2 == 'hs_code'){
                                            ...
                                            //Port Url
                                            $port_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $filterdata ,'filterdata1' => $unloading_port??'default']);
                                            ...
                                            //Hs_code
                                            $hs_code_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $filterdata ,'filterdata1' => $unloading_port??'default']);
                                            //Country url
                                            $country_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $filterdata ,'filterdata1' => $unloading_port??'default']);
                                            //Port Url                                                           //Port Url 
                                            $port_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $filterdata ,'filterdata1' => $unloading_port??'default']);
                                    ...
                                    if(count($args)==7){
                                        ...
                                        //Port Url
                                            $port_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby2' => 'port','filterby'=>$filterby,'filter'=>$searchDetails1,'filterby1'=>$filterby1,'filterdata' => $filterdata1, 'filterdata1' => $unloading_port]);
                                        //Country Url
                                            $country_url = route('searchfilterone', ['country'=>$search_country,'type' => $type, 'role' => $role,'filterby1' => 'country','filterby'=>$filterby,'filterdata'=>$searfilterdata,'filterdata1' => $country]);
                                        ...
                                        if($filterby1 == 'country'){
                                            ...
                                            $port_url =route('search-filter-two', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'searchDetails1'=>$searchDetails1, 'filterby2' => 'port','filterby'=>$filterby,'filter'=>$filterdata,'filterby1'=>$filterby1,'filterdata' => $filterdata1,'filterdata1' => $unloading_port??'Default']);
                                            }else{
                                        ...
                                        //HS_code Url
                                            ...
                                            $hs_code_url  = route('search-filter-two', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'searchDetails1'=>$searchDetails1, 'filterby2' => 'port','filterby'=>$filterby,'filter'=>$res_hs_code,'filterby1'=>$filterby1,'filterdata' => $filterdata,'filterdata1' => $filterdata1??'Default']);
                                            //Country url
                                            $country_url  =route('search-filter-two', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'searchDetails1'=>$searchDetails1, 'filterby2' => 'port','filterby'=>$filterby,'filter'=>$filter,'filterby1'=>$filterby1,'filterdata' => $filterdata,'filterdata1' => $filterdata1??'Default']);
                                            //Port Url                                                           
                                            $port_url  =route('search-filter-two', ['country'=>$search_country,'type' => $type, 'role' => $role,'search'=>$search,'searchDetails1'=>$searchDetails1, 'filterby2' => 'port','filterby'=>$filterby,'filter'=>$filter,'filterby1'=>$filterby1,'filterdata' => $filterdata,'filterdata1' => $filterdata1??'Default']);
                ...
                @foreach ($Mresult as $Mresult)
                    ...
                    <div class="data-mobile-card mb-4">
                        ...
                        <div class="row col-sm-12 col-md-12">
                            ...
                            <div class="col-sm-6 col-md-6 text-center">1
                                <h2 class="fs-4 fw-normal">QTY</h2>
                            </div>
                            <div class="col-sm-6 col-md-6 text-center">
                                <p class="fs-6 fw-light p-2">
                                    {{$Mresult->COMERCIAL_QUANTITY}}
                                </p>
                            </div>
                            <div class="col-sm-6 col-md-6 text-center">
                            ...
                            {{-- @dd($searchDetails1) --}}
                                @php
                                    ...
                                    if ($all_numeric) {                              
                                        ...
                                        //dd('IN Else Block',$filterby2??"null",$filterby,$filterby1,$args,$arg,$filterdata);
                                        if(count($args)==7){
                                            if($filterby1=='port'){
                                                $country_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role, 'filterby2' => 'country','filterby'=>$filterby,'filter'=>$filterdata,'filterby1'=>$filterby1,'filterdata' => $filterdata1, 'filterdata1' => $Dresult->DESTINATION_COUNTRY]);
                                                $hs_code_url = route('searchfiltertwo', ['country'=>$search_country,'type' => $type, 'role' => $role, 'filterby2' => $filterby1,'filterby'=>$filterby,'filter'=>$filterdata,'filterby1'=>'hs_code','filterdata' => $res_hs_code??"null", 'filterdata1' => $unloading_port??'null']);
                                ...
                                <tr>
                                    ...
                                    <td class="fw-normal text-gray p-3">
                                        <p>{{ $Dresult->COMERCIAL_QUANTITY }}</p>
                                    </td>
                                    <td class="fw-normal text-gray p-3">
                                        <p>{{$Dresult->STAT_UNIT}}</p>
                                    </td>
                                    <td class="fw-normal text-gray p-3">
                                        <p>{{$Dresult->US_FOB_ITEM}}</p>
                                    </td>
                                    <td class="fw-normal text-gray p-3">
                                        <a href="#" id="importer-name-link">
                                            Exporter Name
